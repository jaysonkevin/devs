<template>
    ...
    <div class="bg-light">
        <div class="container py-5">
            ...
            <div class="col-lg-12">
                <h1 class="display-4">Terms And Condition</h1>
    ...
    <p class="text__3yL_E textItalic__18RfY textBase__k7xsv textWarmGrey__1WUnc textP__1Apor">Last updated on 1 Nov 2020</p>
                </div>
            </div>
            <div class="col-lg-6 d-none d-lg-block"><img :src="'/image/lock.png'" alt="" class="img-fluid"></div>
            </div>
        </div>
    </div>
